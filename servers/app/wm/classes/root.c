...
D_DEBUG_DOMAIN( Prophecy_Root, "Prophecy/Root", "Prophecy's Root Region Class" );
             ...
             int              num )
{
     ...
     D_DEBUG_AT( Prophecy_Root, "root_update( region %p, num %d )\n", region, num );
#if D_DEBUG_ENABLED
     for (i=0; i<num; i++) {
          D_DEBUG_AT( Prophecy_Root, "    (%d)  %4d,%4d - %4dx%4d\n",
 ...
 */
const StretRegionClass prophecy_root_region_class = {
     Update:   root_update
};
