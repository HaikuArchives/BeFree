...
#ifndef __PROPHECY__INTERNAL_H__
#define __PROPHECY__INTERNAL_H__
...
#define PROPHECY_WM_ABI_VERSION 12


extern const StretRegionClass prophecy_root_region_class;
extern const StretRegionClass prophecy_frame_region_class;
extern const StretRegionClass prophecy_window_region_class;
extern const StretRegionClass prophecy_foo_region_class;

extern const UniqueDeviceClass prophecy_pointer_device_class;
extern const UniqueDeviceClass prophecy_wheel_device_class;
extern const UniqueDeviceClass prophecy_keyboard_device_class;
...
struct __Prophecy_UniqueContext {
     FusionObject             object;
...
struct __Prophecy_UniqueWindow {
     FusionObject             object;
...
struct __Prophecy_UniqueDecoration {
     FusionObject             object;
...
struct __Prophecy_UniqueDecorationItem {
...
struct __Prophecy_UniqueDevice {
     int                      magic;
...
struct __Prophecy_UniqueInputFilter {
     DirectLink               link;
...
struct __Prophecy_UniqueInputSwitch {
     int                      magic;
...
struct __Prophecy_UniqueInputChannel {
     int                      magic;
...
DFBResult prophecy_wm_module_init  ( CoreDFB  *core,
                                   WMData   *data,
                                   WMShared *shared,
                                   bool      master );

void      prophecy_wm_module_deinit( WMData   *data,
                                   WMShared *shared,
                                   bool      master,
                                   bool      emergency );

UniqueContext    *prophecy_wm_create_context();
UniqueDecoration *prophecy_wm_create_decoration();
UniqueWindow     *prophecy_wm_create_window();

/* HACK: temporary, will move into cursor class */
void prophecy_draw_cursor( CoreWindowStack *stack, UniqueContext *context, CardState *state, DFBRegion *region );


/* global reactions */
ReactionResult _prophecy_device_listener              ( const void *msg_data,
                                                      void       *ctx );

ReactionResult _prophecy_wm_module_context_listener   ( const void *msg_data,
                                                      void       *ctx );

ReactionResult _prophecy_wm_module_window_listener    ( const void *msg_data,
                                                      void       *ctx );

ReactionResult _prophecy_cursor_device_listener       ( const void *msg_data,
                                                      void       *ctx );

ReactionResult _prophecy_input_switch_device_listener ( const void *msg_data,
                                                      void       *ctx );

ReactionResult _prophecy_window_input_channel_listener( const void *msg_data,
                                                      void       *ctx );
