...
D_DEBUG_DOMAIN( Prophecy_Pointer, "Prophecy/Pointer", "Prophecy's Pointer Device Class" );
                    ...
                    void            *ctx )
{
     ...
     D_DEBUG_AT( Prophecy_Pointer, "pointer_initialize( %p, %p, %p )\n", device, data, ctx );
                  ...
                  void            *ctx )
{
     ...
     D_DEBUG_AT( Prophecy_Pointer, "pointer_shutdown( %p, %p, %p )\n", device, data, ctx );
                   ...
                   CoreInputDevice *source )
{
     ...
     D_DEBUG_AT( Prophecy_Pointer, "pointer_connected( %p, %p, %p, %p )\n",
                      ...
                      CoreInputDevice *source )
{
     ...
     D_DEBUG_AT( Prophecy_Pointer, "pointer_disconnected( %p, %p, %p, %p )\n",
                 device, data, ctx, source );
}
                       ...
                       const DFBInputEvent *event )
{
     ...
     D_DEBUG_AT( Prophecy_Pointer, "pointer_process_event( %p, %p, %p, %p ) <- type 0x%08x\n",
...
const UniqueDeviceClass prophecy_pointer_device_class = {
